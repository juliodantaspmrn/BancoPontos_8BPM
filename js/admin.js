...
function gerarPDFCompensacao(d) {
  ...
  const codigo = "8BPM-" + Math.random().toString(36).substr(2, 8).toUpperCase();
  ...
  doc.setFontSize(11);
  doc.text("8º BATALHÃO DE POLÍCIA MILITAR", 105, 22, { align: "center" });
  ...
  doc.text(
    ...
    "foi concedida conforme normas internas do 8º Batalhão de Polícia Militar, " +
...
function gerarPDFConsulta() {
  ...
  doc.setFontSize(14);
  doc.setTextColor(0);
  doc.text("RELATÓRIO DE PONTUAÇÃO – 8º BPM", 105, 12, { align: "center" });
  ...
  doc.save("Relatorio_Pontuacao_Geral_8BPM.pdf");
}
